...
public class ActualizarReserva extends javax.swing.JInternalFrame {
    ...
    private void btBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarActionPerformed
        ...
        if (reserva!=null) {
            jtIdHuesped.setText(reserva.getHuesped().getId_huesped()+"");
            jtIngreso.setText(reserva.getIngreso().toString());
            jtEgreso.setText(reserva.getEgreso().toString());
            jtImporteTotal.setText(reserva.getImporte_total()+"");
            
            int personas = reserva.getCantidad_personas();
            cbCantMax.setSelectedItem(personas);
            
            
            TipoDeHabitacion tipo = reserva.getHabitacion().getTipo_de_habitacion();
            cbTipo.setSelectedItem(tipo);
        
           }else{
          JOptionPane.showMessageDialog(this, "La reserva no se encuentra cargada\n Complete los campos para agregar una nueva");
        } 
